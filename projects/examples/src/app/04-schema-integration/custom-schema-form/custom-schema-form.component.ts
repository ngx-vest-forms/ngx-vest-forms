...
export class CustomSchemaFormComponent {
  ...
  protected readonly description =
    'This example demonstrates <strong>custom schema validation</strong> with <code>ngx-vest-forms</code> via <code>ngxModelToStandardSchema</code>.';
  protected readonly infoBlock = `
    <ul class="info-box-list">
      <li>Type inference and basic runtime validation from your object template</li>
      <li>Vest.js: All validation logic (field-level, cross-field, async)</li>
      <li>No external dependencies required</li>
      <li>Best for simple forms and rapid prototyping</li>
      <li>For deep validation, use Zod/Valibot/ArkType</li>
    </ul>
  `;
}
