      ...
      <section class="form-section">
        <div class="form-group">
          ...
          <input
            ...
            class="nv-input"
          />
          <div class="nv-hint">Will check availability on server</div>
        </div>
        ...
        <div class="form-group">
          ...
          <input
            ...
            class="nv-input"
          />
          <div class="nv-hint">Will verify email is not already registered</div>
        </div>
        ...
        <div class="form-group">
          ...
          <input
            ...
            class="nv-input"
          />
          <div class="nv-hint">Will check if URL is reachable</div>
        </div>

        <button type="submit" class="nv-btn">
