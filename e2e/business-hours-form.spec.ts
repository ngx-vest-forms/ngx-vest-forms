...
test.describe('Business Hours Form', () => {
  ...
  test.describe('ROOT_FORM Array Validation', () => {
    ...
    test.fixme('should show ROOT_FORM error when no business hours are added', async ({
      page,
    }) => {
  ...
  test.describe('Time Field Validation', () => {
    test('should require from and to fields', async ({ page }) => {
      await test.step('Focus and blur time fields without input', async () => {
        // Scope to "Add New Business Hour" group to avoid strict-mode ambiguity
        // once items have been added (there can be multiple from/to inputs).
        const addNewSlot = page.locator('[ngModelGroup="addValue"]');
    ...
    test.fixme('should validate that "to" time is after "from" time', async ({
      page,
    }) => {
    ...
    // Validation logic works correctly in production (verified via manual testing)
    // Issue: Race condition in test between Angular change detection and Vest validation
    test.fixme('should clear error when "to" time is corrected to be after "from" time', async ({
      page,
    }) => {
  ...
  test.describe('Multiple Time Slots Validation', () => {
    ...
    // FIXME: Form array test - strict mode violations
    test.fixme('should require chronological ordering of time slots', async ({
      page,
    }) => {
    ...
    // FIXME: Form array test - strict mode violations
    test.fixme('should clear overlap error when overlapping slot is removed', async ({
      page,
    }) => {
    ...
    test.fixme('should validate each added slot individually', async ({
      page,
    }) => {
  ...
  test.describe('Edit Business Hour', () => {
    // FIXME: Form array test - items not added to array
    test.fixme('should allow editing existing business hours', async ({
      page,
    }) => {
    ...
    // FIXME: Form array test - items not added to array
    test.fixme('should maintain validation rules when editing', async ({
      page,
    }) => {
  ...
  test.describe('Remove Business Hour', () => {
    // FIXME: Form array test - strict mode violations
    test.fixme('should remove business hour and revalidate form', async ({
      page,
    }) => {
    ...
    test.fixme('should show ROOT_FORM error if all business hours are removed', async ({
      page,
    }) => {
